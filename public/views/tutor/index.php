                ...
                <div class="card mb-3">
                    <div class="card-body bg-light-subtle">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <a href="/app-pasantias/tutor-create"><button type="button" class="btn btn-success btn-sm align-middle">
                            ...
                            if(empty($data)){
                                ...
                                foreach($data as $i=>$d){ ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo $d['cedula_tutor']; ?></td>
                                        ...
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            <a href="/app-pasantias/tutor-delete/<?php echo $d['id_tutor']; ?>">
